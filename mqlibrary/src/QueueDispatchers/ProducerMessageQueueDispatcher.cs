...
/// <summary>
/// Class for processing the message queue from the producer side.
/// </summary>
public class ProducerMessageQueueDispatcher : IMessageQueueDispatcher
{
    ...
    /// Default constructor.
    /// </summary>
    public ProducerMessageQueueDispatcher(
